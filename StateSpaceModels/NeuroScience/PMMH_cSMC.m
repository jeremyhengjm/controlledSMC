% PMCMC on Demba's neuroscience example
clear
close 
clc
...
proposal_std = [0.002 0.01]; % proposal standard deviation
...
for m = 1:M
    m
    if (mod(m,1000) == 0)
        save('PMMH_cSMC.mat','theta_cSMC','naccept','m')
    end
