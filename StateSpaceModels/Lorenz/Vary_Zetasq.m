...
Transition.G = sigmasq * interval * eye(d); % should this be right?
...
% APF_Parameters.Particles = 1382; % d = 2^3
% APF_Parameters.Particles = 2027; % d = 2^4
% APF_Parameters.Particles = 4034; % d = 2^5
APF_Parameters.Particles = 11468; % d = 2^6
...
% cSMC_Parameters.Particles = 2^9; % d = 2^3, 2^4
% cSMC_Parameters.Particles = 2^10; % d = 2^5
cSMC_Parameters.Particles = 2^12; % d = 2^6
...
for izetasq = 1:nzetasq
    ...
    for irep = 1:nrep
        ...
        APF_ESS(irep,izetasq) = OutputAPF.ESS;
        ...
        cSMC_ESS(irep,izetasq) = OutputSMC.ESS;
%         min(OutputSMC.ESS) * 100 / cSMC_Parameters.Particles
